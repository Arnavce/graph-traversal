...
void DSF(GraphList* graph, int start_vertex) {
...
int main(){
    ...
    add_edge_list(gMatrix, 5, 6);
    add_edge_list(gMatrix, 5, 7);
    add_edge_list(gMatrix, 5, 8);
    add_edge_list(gMatrix, 6, 7);
    add_edge_list(gMatrix, 7, 9);
